...
//var exemple = ['1','2','3']
//var exemple2 = exemple[1] == 1; exemple[2] == 2;...
...
for (var i = 0;i < 4;i++)
{
        ...
        strFinal += str1[i]+str2;
        }
}
document.write("Vous avez selectionné le mot : "+str1[n]);
console.log (str1[n]);
console.log(strFinal);
}
var str1 = ["Robert","Dupont","Amiens","80000"]
var n = window.prompt('Ecrivez le numéro du mot que vous souhaitez selectionner : "Robert,Dupont,Amiens,80000"');
...
*/
                            ...
                            //Ici, l'utilisateur rentre toutes les données qu'il veut avant de selectionner le mot dans la phrase
/*
function strTok(str1,str2,n){
    var strFinal = "";
    var c = -1;
    var str2 = window.prompt('Entrez ici le signe de ponctuation entre vos mots: ');
        var str1 = [];
        do {
            str1.push(prompt("Entrez ici: "));
            if (str1[c] != "")
            {
                c++;
            }
            strFinal += str1[c]+str2;
        }
        while (str1[c] != "")
       //c = sert a avoir un nombre défini de str1 [...,c-2,c-1,c]  (position maximale)
        str1.pop();
        str1Final = strFinal.substring(0,strFinal.length -2);
        window.alert("Voici votre phrase: "+str1Final);
        var n = window.prompt('Ecrivez le numéro du mot que vous souhaitez selectionner');
        n--;
                document.write("Vous avez selectionné le mot : "+str1[n]);
                document.write("<br>"+"Voici votre phrase: "+str1Final);
                            console.log(str1);
                            console.log(strFinal);
                        }
strTok()
...
var n = window.prompt('Saisissez la taille de votre tableau : ');
var myTableau = [n];
var i = 0;

for (i;i<n;i++)
{
    myTableau[i] = window.prompt("Saisissez la valeur n°"+(i+1)+" pour le tableau : ");
}
